...
namespace OnlineClearance.DAL
{
    public class RolesContext : DataAccessHelper
    {
        ...
        private static string _pkField = "userTypeID";
        private static string _tableName = "tblusertype";
        ...
        private List<string> TargetFields
        {
            get
            {
                return new List<string> { "userTypeName" };
            }
        }
            ...
            get
            {
                ...
                using (MySqlConnection myConn = MySqlConn)
                {
                    ...
                    while (rd.Read())
                    {
                        ...
                        role.Name = rd["userTypeName"].ToString();
                        roles.Add(role);
                    }
                    myConn.Close();
                }
        ...
        private Dictionary<string, object> SetParams(Roles role)
        {
            Dictionary<string, object> result = new Dictionary<string, object>();

            result.Add("@userTypeName", role.Name);
